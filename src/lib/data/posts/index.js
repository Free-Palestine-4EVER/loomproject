...
import { post as ecommerceJordanCliqCodCheckout } from './ecommerce-jordan-cliq-cod-checkout.js'
import { post as instagramOrWebsiteJordanSmb } from './instagram-or-website-jordan-smb.js'
import { post as websiteDesignAgencyAmman } from './website-design-agency-amman.js'
import { post as productVisualisationJordan } from './3d-product-visualisation-jordan.js'
...
const ALL = [
  ...
  aiNativeAgency,
  ecommerceJordanCliqCodCheckout,
  instagramOrWebsiteJordanSmb,
  websiteDesignAgencyAmman,
  productVisualisationJordan,
]
