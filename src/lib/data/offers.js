...
export const THE_MACHINE = {
  ...
  arabicPitch:
    'تقدّم LOOM باقة محتوى شهرية تشمل ٢٠ صورة وفيديوهين بالعربية والإنجليزية، مع مراجعة بشرية قبل النشر. يبدأ السعر المعلن من ٨٩ دينارًا أردنيًا شهريًا، ويُحدَّد العرض النهائي بحسب نطاق العمل.',
}
